...
func TestHelpMessage(t *testing.T) {
	...
	compare("  ENV_TWO <string>,<string>   this is env one, it holds a comma separate list of 2 things")
	compare("")
...
func TestGenerateConfig(t *testing.T) {
	...
	compare("# export ENDPOINTS=<string>,<string>")
	compare("")
	...
	compare("")
	compare("# A comma separated list of endpoints our application can connect too")
	compare("# endpoints=<string>,<string>")
	compare("")
	compare(`# This is a rather simple thing (Default:"Let's call it a thingamajig")`)
